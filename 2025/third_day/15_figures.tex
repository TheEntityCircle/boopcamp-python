...
\includegraphics{15_out_img.png}. % Эта картинка лежит в одной папке с данным .tex файлом.
...
Попытка 2: 
\includegraphics[scale=0.3]{15_out_img.png}

другие способы указания размера картинки:


\includegraphics[width=7cm]{15_out_img.png}

\includegraphics[height=40pt]{15_out_img.png}

В долях от ширины текста:

\includegraphics[width=0.5\textwidth]{15_out_img.png}
