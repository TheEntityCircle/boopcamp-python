"""
Попробуем немного поиграться с оформлением графиков
"""
...
# Поэкспериментируем со стилями линий самих графиков
plt.plot(x, y1, label='linear',
          marker='o', # тип маркера, отображаемого на месте указанных точек
          linestyle='-', # тип линии, соединяющей точки
