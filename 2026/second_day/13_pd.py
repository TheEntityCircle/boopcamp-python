...
# Вместо парсинга руками воспользуемся готовой функцией
data = pd.read_csv('./data_files/data.csv')

print(data) # Результат немного не такой, как хотелось бы

data_correct = pd.read_csv('./data_files/data.csv', header=None)
...
excel_data = pd.read_excel('./data_files/data.xlsx', header=None).to_numpy()
